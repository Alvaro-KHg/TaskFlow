...
export const TAGS = ['Trabalho Final', 'Lista de Exercícios', 'Pesquisa', 'Apresentação', 'Projeto Prático', 'Leitura', 'Sprint1', 'Sprint2', 'Sprint3', 'Sprint4', 'Sprint5', 'Sprint6', 'Sprint7', 'Sprint8', 'Daily'];
